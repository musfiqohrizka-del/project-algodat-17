public class App {
    public static void main(String[] args) {
        ...
        linkedPasien allPasien = new linkedPasien(); 
        ...
        allPasien.addPasien(p21);
        riwayatTindakan.push(p21);
        riwayatTindakan.pop();


        System.out.println("\n===== Antrian Semua Pasien  =====");
        antrianGlobal.displayQueue();

        System.out.println("\n===== DAFTAR SEMUA PASIEN (SORTING NAMA) =====");
        allPasien.displaySortedByName();

        System.out.println("\n===== DAFTAR SEMUA PASIEN (SORTING USIA) =====");
        allPasien.displaySortedByAge();
        ...
        rumahSakit.insert(50, "Ruang Kepala RS (Pusat)"); 
        rumahSakit.insert(30, "Ruang IGD");       
        rumahSakit.insert(70, "Ruang Poliklinik"); 
        rumahSakit.insert(20, "Ruang Parkir");    
        rumahSakit.insert(80, "Ruang Bedah");     
